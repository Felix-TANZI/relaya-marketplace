...
urlpatterns = [
    ...
    path("admin/categories/",
         views.admin_categories_list,
         name="admin-categories-list"),
    path("admin/categories/tree/",
         views.admin_categories_tree,
         name="admin-categories-tree"),
    path("admin/categories/create/",
         views.admin_categories_create,
         name="admin-categories-create"),
    path("admin/categories/bulk-set-flag/",
         views.admin_categories_bulk_set_flag,
         name="admin-categories-bulk-set-flag"),
    path("admin/categories/<int:cat_id>/",
         views.admin_category_detail,
         name="admin-category-detail"),
    path("admin/categories/<int:cat_id>/update/",
         views.admin_category_update,
         name="admin-category-update"),
    path("admin/categories/<int:cat_id>/delete/",
         views.admin_category_delete,
         name="admin-category-delete"),
    path("admin/categories/<int:cat_id>/toggle-active/",
         views.admin_category_toggle_active,
         name="admin-category-toggle-active"),
    path("admin/categories/<int:cat_id>/toggle-deprecated/",
         views.admin_category_toggle_deprecated,
         name="admin-category-toggle-deprecated"),
    path("admin/categories/<int:cat_id>/toggle-approval/",
         views.admin_category_toggle_approval,
         name="admin-category-toggle-approval"),
    path("admin/categories/<int:cat_id>/move/",
         views.admin_category_move,
