...
export const router = createBrowserRouter([
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    children: [
      ...
      { path: 'orders/map',           element: <AdminStub title="Carte Commandes & Livraisons" description="Bientôt disponible." icon={MapPin} backHref="/admin/orders" backLabel="Retour commandes" /> },
