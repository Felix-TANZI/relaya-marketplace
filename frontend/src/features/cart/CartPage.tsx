...
import { ArrowRight, Check, Minus, Package, Plus, ShieldCheck, ShoppingCart, Store, Trash2, Truck } from "lucide-react";
                    ...
                    <div key={item.id} className={`pf-line${selected ? "" : " off"}`}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
                          ...
                          <button className="pf-del" onClick={() => removeItem(item.id)} aria-label={`Retirer ${item.name}`}>
                            <Trash2 size={15} />
                          </button>
                        </div>
