    ...
    <div>
      ...
      >
        ...
        <div style={{ color: "rgb(var(--muted))", fontSize: 13 }}>
          ...
          <strong style={{ color: "rgb(var(--text))" }}>{draft.city}</strong>
        </div>
        <div style={{ color: "rgb(var(--muted))", fontSize: 13 }}>
          {t("checkout.address", "Address")}:{" "}
          <strong style={{ color: "rgb(var(--text))" }}>{draft.address}</strong>
        </div>
        <div style={{ color: "rgb(var(--muted))", fontSize: 13 }}>
          {t("checkout.phone", "Phone")}:{" "}
          <strong style={{ color: "rgb(var(--text))" }}>{draft.phone}</strong>
        </div>
        {draft.note ? (
          <div style={{ color: "rgb(var(--muted))", fontSize: 13 }}>
            {t("checkout.note", "Note")}:{" "}
            <strong style={{ color: "rgb(var(--text))" }}>{draft.note}</strong>
          </div>
        ) : null}
      </div>
      ...
      >
        ...
        <div style={{ marginTop: 14, display: "flex", gap: 10 }}>
          ...
          <button
            style={{ ...btnStyle(), background: "rgb(var(--text))", color: "rgb(var(--bg))" }}
            disabled
          >
