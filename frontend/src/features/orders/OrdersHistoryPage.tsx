...
import { Package, ShoppingBag, AlertCircle, Calendar, MapPin } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mb-8">
          <h1 className="font-display font-bold text-4xl lg:text-5xl mb-2">
            <span className="text-gradient animate-gradient-bg">{t('orders.title')}</span>
          </h1>
              ...
              <div className="p-6">
                  ...
                  {order.items.map((item) => (
                    <div key={item.id} className="flex items-center justify-between text-sm">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-dark-text">{item.title_snapshot}</span>
                        <span className="text-dark-text-tertiary">x{item.qty}</span>
                      </div>
                ...
                <div className="pt-4 border-t border-white/10">
                  <p className="text-sm text-dark-text-secondary">
                    <span className="font-medium text-dark-text">{t('checkout.address_label')}:</span> {order.address}
                  </p>
                </div>
              </div>
            </Card>
