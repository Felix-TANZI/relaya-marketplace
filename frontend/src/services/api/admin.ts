...
export type UpdateCourierPayload = Partial<
  Omit<CreateCourierPayload, "username">
> & {
  is_active?: boolean;
  is_approved?: boolean;
  is_online?: boolean;
...
export const adminApi = {
  ...
  listCouriers: async (): Promise<AdminCourier[]> =>
    http<AdminCourier[]>("/api/auth/admin/couriers/", {
      headers: authHeader(),
    }),
  ...
  getVendorDetail: async (vendorId: number): Promise<VendorProfile> =>
    http<VendorProfile>(`/api/vendors/admin/vendors/${vendorId}/`, {
      headers: authHeader(),
    }),

  /** Approuver un vendeur */
  approveVendor: async (vendorId: number): Promise<VendorProfile> =>
    http<VendorProfile>(`/api/vendors/admin/vendors/${vendorId}/approve/`, {
      method: "POST",
      headers: authHeader(),
    }),
  ...
  rejectVendor: async (vendorId: number): Promise<VendorProfile> =>
    http<VendorProfile>(`/api/vendors/admin/vendors/${vendorId}/reject/`, {
      method: "POST",
      headers: authHeader(),
    }),
  ...
  suspendVendor: async (vendorId: number): Promise<VendorProfile> =>
    http<VendorProfile>(`/api/vendors/admin/vendors/${vendorId}/suspend/`, {
      method: "POST",
      headers: authHeader(),
    }),
  ...
  listProducts: async (filters?: {
    ...
    return http<AdminProduct[]>(
      `/api/vendors/admin/products/${qs ? "?" + qs : ""}`,
      { headers: authHeader() },
    );
  },

  /** Détail complet d'un produit (admin) */
  ...
  updateProduct: async (
    ...
    http<AdminProductDetail>(
      `/api/vendors/admin/products/${productId}/update/`,
      {
        method: "PATCH",
        headers: authHeader(),
        body: JSON.stringify(data),
  ...
  toggleProductStatus: async (productId: number): Promise<AdminProductDetail> =>
    http<AdminProductDetail>(
      `/api/vendors/admin/products/${productId}/toggle-status/`,
      { method: "POST", headers: authHeader() },
    ),

  /** Approuver un produit (modération) */
  approveProduct: async (productId: number): Promise<AdminProduct> =>
    http<AdminProduct>(`/api/vendors/admin/products/${productId}/approve/`, {
      method: "POST",
      headers: authHeader(),
    }),

  /** Rejeter un produit avec motif optionnel */
  rejectProduct: async (
    productId: number,
    reason?: string,
  ): Promise<AdminProduct> =>
    http<AdminProduct>(`/api/vendors/admin/products/${productId}/reject/`, {
      method: "POST",
      headers: authHeader(),
  ...
  listOrders: async (filters?: OrderFilters): Promise<AdminOrder[]> => {
    ...
    if (filters?.search) params.append("search", filters.search);
    const qs = params.toString();
    return http<AdminOrder[]>(
      `/api/vendors/admin/orders/${qs ? "?" + qs : ""}`,
      { headers: authHeader() },
    );
  },
  ...
  getOrderDetail: async (orderId: number): Promise<AdminOrderDetail> =>
    http<AdminOrderDetail>(`/api/vendors/admin/orders/${orderId}/`, {
      headers: authHeader(),
    }),
  ...
  cancelOrder: async (orderId: number): Promise<AdminOrderDetail> =>
    http<AdminOrderDetail>(`/api/vendors/admin/orders/${orderId}/cancel/`, {
      method: "POST",
      headers: authHeader(),
    }),
  ...
  listUsers: async (filters?: UserFilters): Promise<AdminUser[]> => {
    ...
    if (filters?.is_banned !== undefined)
      params.append("is_banned", filters.is_banned.toString());
    if (filters?.is_active !== undefined)
      params.append("is_active", filters.is_active.toString());
    if (filters?.date_from) params.append("date_from", filters.date_from);
    if (filters?.date_to) params.append("date_to", filters.date_to);
    if (filters?.search) params.append("search", filters.search);
    const qs = params.toString();
    return http<AdminUser[]>(`/api/vendors/admin/users/${qs ? "?" + qs : ""}`, {
      headers: authHeader(),
    });
  },
  ...
  getUserDetail: async (userId: number): Promise<AdminUserDetail> =>
    http<AdminUserDetail>(`/api/vendors/admin/users/${userId}/`, {
      headers: authHeader(),
    }),
  ...
  unbanUser: async (userId: number): Promise<AdminUserDetail> =>
    http<AdminUserDetail>(`/api/vendors/admin/users/${userId}/unban/`, {
      method: "POST",
      headers: authHeader(),
    }),
  ...
  deleteUser: async (userId: number): Promise<void> =>
    http<void>(`/api/vendors/admin/users/${userId}/delete/`, {
      method: "DELETE",
      headers: authHeader(),
    }),
  ...
  listDisputes: async (filters?: DisputeFilters): Promise<AdminDispute[]> => {
    ...
    if (filters?.search) params.append("search", filters.search);
    const qs = params.toString();
    return http<AdminDispute[]>(
      `/api/vendors/admin/disputes/${qs ? "?" + qs : ""}`,
      { headers: authHeader() },
    );
  },
  ...
  getDisputeStats: async (): Promise<DisputeStats> =>
    http<DisputeStats>("/api/vendors/admin/disputes/stats/", {
      headers: authHeader(),
    }),

  /** Détail d'un litige */
  getDisputeDetail: async (disputeId: number): Promise<AdminDisputeDetail> =>
    http<AdminDisputeDetail>(`/api/vendors/admin/disputes/${disputeId}/`, {
      headers: authHeader(),
    }),
  ...
  updateDispute: async (
    disputeId: number,
    data: AdminDisputeUpdate,
  ): Promise<AdminDisputeDetail> =>
    http<AdminDisputeDetail>(
      `/api/vendors/admin/disputes/${disputeId}/update/`,
      {
        method: "PATCH",
        headers: authHeader(),
        body: JSON.stringify(data),
  ...
  addDisputeMessage: async (
    ...
    http<AdminDisputeDetail>(
      `/api/vendors/admin/disputes/${disputeId}/message/`,
      {
        method: "POST",
        headers: authHeader(),
  ...
  resolveDispute: async (
    ...
    http<AdminDisputeDetail>(
      `/api/vendors/admin/disputes/${disputeId}/resolve/`,
      {
        method: "POST",
        headers: authHeader(),
        body: JSON.stringify({
  ...
  toggleDisputeReply: async (
    ...
    http<AdminDisputeDetail>(
      `/api/vendors/admin/disputes/${disputeId}/toggle-reply/`,
      {
        method: "POST",
        headers: authHeader(),
  ...
  listCouriersSimple: async (): Promise<AdminCourierSimple[]> =>
    http<AdminCourierSimple[]>("/api/vendors/admin/couriers/", {
      headers: authHeader(),
    }),
  ...
  approveSubscription: async (subId: number) =>
    http(`/api/vendors/admin/subscriptions/${subId}/approve/`, {
      method: "POST",
      headers: authHeader(),
    }),
  ...
  rejectSubscription: async (subId: number) =>
    http(`/api/vendors/admin/subscriptions/${subId}/reject/`, {
      method: "POST",
      headers: authHeader(),
    }),
  ...
  listReviews: async (filters?: { is_approved?: boolean; rating?: number }) => {
    ...
    const qs = params.toString();
    return http(`/api/vendors/admin/reviews/${qs ? "?" + qs : ""}`, {
      headers: authHeader(),
    });
  },
  ...
  toggleReview: async (reviewId: number) =>
    http(`/api/vendors/admin/reviews/${reviewId}/toggle/`, {
      method: "POST",
      headers: authHeader(),
    }),
  ...
  deleteReview: async (reviewId: number) =>
    http(`/api/vendors/admin/reviews/${reviewId}/delete/`, {
      method: "DELETE",
      headers: authHeader(),
    }),
  ...
  listModifications: async (status = "PENDING") =>
    http(`/api/vendors/admin/modifications/?status=${status}`, {
      headers: authHeader(),
    }),
  ...
  getSettings: async (): Promise<PlatformSettings> =>
    http<PlatformSettings>("/api/vendors/admin/settings/", {
      headers: authHeader(),
    }),
